...
export function setupMappingStep(state) {
    ...
    function getGuidedProperty(kind) {
        const guidedProperties = {
            label: {
                id: 'label',
                label: 'Labels',
        ...
        return guidedProperties[kind] || null;
    }
    ...
    function openGuidedMappingModal(kind) {
        ...
        openMappingModal({
            ...
            modalMode: kind,
            guidedProperty,
            isMetadata: Boolean(guidedProperty?.isMetadata)
        });
    }

    function openModalWithLabelPreselected() {
        openGuidedMappingModal('label');
    }

    function openModalWithInstanceOfPreselected() {
        openGuidedMappingModal('instance_of');
    }
    ...
    if (addDescriptionBtn) {
        addDescriptionBtn.addEventListener('click', () => openGuidedMappingModal('description'));
    }

    const addAliasesBtn = document.getElementById('add-aliases');
    if (addAliasesBtn) {
        addAliasesBtn.addEventListener('click', () => openGuidedMappingModal('aliases'));
    }
